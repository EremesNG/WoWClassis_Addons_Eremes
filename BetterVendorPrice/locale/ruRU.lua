...
local L = _G[addon].L
L[" (current stack of %d)"] = "(за текущий стак %d)"
L[" (full stack of %d)"] = "(за полный стак %d)"
L[" (item doesn't stack)"] = "(предметы не стакаются)"
L[" (per item)"] = "(за единицу)"
...
L["Vendors for:"] = "Торговец заплатит:"
