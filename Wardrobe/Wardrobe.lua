...
StaticPopupDialogs["Wardrobe_NewOutfit"] = {
	text = "New outfit name", button1 = "Ok", button2 = "Cancel",
...
StaticPopupDialogs["Wardrobe_CustomIconDialog"] = {
	text = "Enter the numeric fileID for the texture you want to use.\n\nThese can found via wowhead and are a 6 digit number.", button1 = "Ok", button2 = "Cancel",
    hasEditBox = true, EditBoxOnTextChanged = function(self) if self:GetText() ~= '' then self:GetParent().button1:Enable() else self:GetParent().button1:Disable() end end,
	OnShow = function(self) self.editBox:SetText('') self.button1:Disable() end,
    ...
    if ItemLink then
        ...
        if setsString ~= nil then
            if not Wardrobe.Vars.TooltipLineAdded then
                ...
                tooltip:AddLine("Sets", 1.00, 0.49, 0.04)
...
Wardrobe.UI.OutfitFrame.NewOutfitButton:SetText('New Set')
...
Wardrobe.UI.OutfitFrame.SaveCurrentlyEquippedButton:SetText('Save')
...
Wardrobe.UI.OutfitFrame.DeleteCurrentSet:SetText('Delete')
...
Wardrobe.UI.OutfitFrame.EquipCurrentSet:SetText('Equip')
...
WardrobeUIHelmCheckboxText:SetText('Helm')
...
Wardrobe.UI.HelmCheckbox.tooltip = 'Show helm for this outfit'
...
WardrobeUICloakCheckboxText:SetText('Cloak')
...
Wardrobe.UI.CloakCheckbox.tooltip = 'Show cloak for this outfit'
...
WardrobeUIOutfitIsOnHUDCheckboxText:SetText('Show on quick panel')
...
Wardrobe.UI.OutfitIsOnHUDCheckbox.tooltip = 'Include outfit on quick panel'
...
Wardrobe.UI.OutfitFrame.IconPickerButton:SetText('Icon')
...
Wardrobe.UI.OutfitFrame.CustomIconPickerButton:SetText('Custom')
...
Wardrobe.UI.QuickPanel.tooltip.SetName:SetFont("Fonts\\FRIZQT__.TTF", 13)
Wardrobe.UI.QuickPanel.tooltip.SetName:SetTextColor(1,1,1,1)
Wardrobe.UI.QuickPanel.tooltip.SetName:SetText('Set Name')
